...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [SRMediator addTabBarControllerChildVCWithParams:@{@"title": @"首页",
                                                       ...
                                                       @"isEmbedInNavC": @(YES)}];
    [SRMediator addTabBarControllerChildVCWithParams:@{@"title": @"鱼塘",
                                                       ...
                                                       @"isEmbedInNavC": @(YES)}];
    [SRMediator addTabBarControllerChildVCWithParams:@{@"title": @"消息",
                                                       ...
                                                       @"isEmbedInNavC": @(YES)}];
    [SRMediator addTabBarControllerChildVCWithParams:@{@"title": @"我的",
    ...
    [SRMediator setTabBarDidSelectMiddleItemBlock:^{
    ...
    self.window.rootViewController = [SRMediator mainTabBarController];
